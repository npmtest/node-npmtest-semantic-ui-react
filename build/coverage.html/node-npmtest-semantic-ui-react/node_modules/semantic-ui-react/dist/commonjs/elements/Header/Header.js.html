...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-semantic-ui-react/node_modules/semantic-ui-react/dist/commonjs/elements/Header/Header.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-semantic-ui-react/node_modules/semantic-ui-react/dist/commonjs/elements/Header/Header.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-semantic-ui-react/node_modules/semantic-ui-react/dist/commonjs/elements/Header/</a> &#187; Header.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function Header(props) {</span>
<span class="cstat-no" title="statement not covered" >  var attached = props.attached,</span>
      block = props.block,
...
<span class="cstat-no" title="statement not covered" >  var rest = (0, _lib.getUnhandledProps)(Header, props);</span>
<span class="cstat-no" title="statement not covered" >  var ElementType = (0, _lib.getElementType)(Header, props);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  var iconElement = _Icon2.default.create(icon);</span>
<span class="cstat-no" title="statement not covered" >  var imageElement = _Image2.default.create(image);</span>
<span class="cstat-no" title="statement not covered" >  var subheaderElement = _HeaderSubheader2.default.create(subheader);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (iconElement || imageElement) {</span>
<span class="cstat-no" title="statement not covered" >    return _react2.default.createElement(</span>
      ElementType,
      (0, _extends3.default)({}, rest, { className: classes }),
