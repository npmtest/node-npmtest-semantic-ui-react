...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-semantic-ui-react/node_modules/semantic-ui-react/dist/commonjs/lib/META.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-semantic-ui-react/node_modules/semantic-ui-react/dist/commonjs/lib/META.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-semantic-ui-react/node_modules/semantic-ui-react/dist/commonjs/lib/</a> &#187; META.js</div>
</div>
<div class="body">
 ...
 * @returns {Boolean}
 */
var isMeta = exports.isMeta = <span class="fstat-no" title="function not covered" >function isMeta(_meta) {</span>
<span class="cstat-no" title="statement not covered" >  return (0, _includes3.default)((0, _get3.default)('type', _meta), TYPE_VALUES);</span>
};
&nbsp;
/**
 ...
 */
var getMeta = <span class="fstat-no" title="function not covered" >function getMeta(metaArg) {</span>
  // literal
<span class="cstat-no" title="statement not covered" >  if (isMeta(metaArg)) <span class="cstat-no" title="statement not covered" >return metaArg;</span></span>
&nbsp;
  // from prop
  else <span class="cstat-no" title="statement not covered" >if (isMeta((0, _get3.default)('_meta', metaArg))) <span class="cstat-no" title="statement not covered" >return metaArg._meta;</span></span>
&nbsp;
    // from class
    else <span class="cstat-no" title="statement not covered" >if (isMeta((0, _get3.default)('constructor._meta', metaArg))) <span class="cstat-no" title="statement not covered" >return metaArg.constructor._meta;</span></span>
};
&nbsp;
var metaHasKeyValue = (0, _curry3.default)(<span class="fstat-no" title="function not covered" >function (key, val, metaArg) {</span>
<span class="cstat-no" title="statement not covered" >  return (0, _flow3.default)(getMeta, (0, _get3.default)(key), (0, _eq3.default)(val))(metaArg);</span>
});
